...
inputs = {
  name      = "image-upload-function-prod"
  use_image = true
  image_uri = get_env("PROD_IMAGE_UPLOAD_IMAGE_URI", "default_image_upload_uri")

  environment_variables = {
    SQS_REGION = get_env("PROD_SQS_REGION", "us-east-1")
    BUCKET_NAME = get_env("PROD_BUCKET_NAME", "demo-bucket")
  ...
  tags = {
    Name               = "image-uploader-lambda-prod"
